...
Right now, you can only query by transaction height: `tx.height`. Please note that on BNB Chain testnet, you can only use this data seed node for tx search: <https://data-seed-pre-0-s3.bnbchain.org>
