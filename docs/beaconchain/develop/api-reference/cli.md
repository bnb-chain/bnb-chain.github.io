...
You can download BNB Beacon Chain CLI releases here: [https://github.com/bnb-chain/node/releases](https://github.com/bnb-chain/node/releases)
...
You could query this API for a list of full node on mainnet: <https://dex.bnbchain.org/api/v1/peers>.
