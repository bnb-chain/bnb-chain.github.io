...
Since the old binaries are stored in `git lfs` previously, you will see this error if the binary is not complete. Please use this [repo](https://github.com/bnb-chain/node/releases) to download the binaries.
