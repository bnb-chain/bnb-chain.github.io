...
## Introduction
Assets are stored as `tokens` on BNB Beacon Chain and the below management actions are available. All the assets are complied with [BEP2](https://github.com/bnb-chain/BEPs/blob/master/BEPs/BEP2.md).
