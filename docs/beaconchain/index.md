...
- Explore the transaction history and blocks on the chain, via [Beacon Chain  Explore](https://explorer.binance.org), [API](./api-reference/dex-api/paths.md)
...
- Extract other data of Beacon Chain  via full node or [APIs](./api-reference/dex-api/paths.md#apiv1markets)
