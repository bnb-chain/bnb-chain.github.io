...
| Indexing            |                       | [Envio](https://envio.dev/?utm_source=opbnb&utm_medium=partner-docs), NodeReal’s opBNB Graph QL                                                                                                                                                                                                                                                                                                                                                                                          |
...
[Envio](https://envio.dev/?utm_source=opbnb&utm_medium=partner-docs) is the data layer for blockchain apps. It gives opBNB developers the fastest, most flexible way to get real-time and historical onchain data, from a single GraphQL API to raw high-speed access, with managed hosting on Envio Cloud. Envio supports opBNB through HyperSync, its data engine that serves as the default data source and syncs historical data up to 2000x faster than traditional RPC. Developers can auto-generate an indexer from any verified contract, write event handlers in TypeScript, JavaScript, or ReScript, and deploy on Envio Cloud or self-host. See the [HyperIndex quickstart](https://docs.envio.dev/docs/HyperIndex/quickstart?utm_source=opbnb&utm_medium=partner-docs) to get started. See Envio's [performance benchmarks](https://docs.envio.dev/docs/HyperIndex/benchmarking?utm_source=opbnb&utm_medium=partner-docs).
