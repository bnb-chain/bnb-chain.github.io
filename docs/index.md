...
<div class="section-body">
    <a href="./bnb-smart-chain/developers/quick-guide.md" class="grid-item">
        <div>BNB Smart Chain</div>
        <p>Getting Started with high performance Layer1 particularly for decentralized finance (DeFi)</p>
    </a>
    <a href="./bnb-opbnb/developers/quick-guide.md" class="grid-item">
        <div>opBNB</div>
        <p>Getting Started with Layer2 scaling solution on BNB Chain ecosystem</p>
    </a>
    <a href="./bnb-greenfield/for-developers/get-started-dev.md" class="grid-item">
