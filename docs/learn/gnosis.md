...
---
#  BNB 스마트 체인에서의 노시스 세이프(Gnosis Safe) 멀티시그
...
노시스 세이프는 멀티시그 기능이 핵심인 스마트 컨트랙트 월렛입니다. 다음의 특징들이 있습니다.
...
## [지금 바로 노시스 세이프 멀티시그를 셋업하세요](https://gnosis-safe.binance.org/#/welcome)

## Gnosis Safe를 사용한 프로젝트

이 [목록](https://docs.gnosis.io/safe/docs/intro_projects/)을 참고해주세요.

## 사용자 가이드

### 노시스 세이프 생성하기
- [웰컴 페이지](https://gnosis-safe.binance.org/#/welcome)로 이동하세요.
...
- "Receive"를 클릭하여 자금 수령을 위해 QR 코드 받기
...
- 다른 이들이 트랜잭션을 거부할 수 있습니다. 다른 트랜잭션을 전송하기만 하면 됩니다.
...
노시스 세이프 스마트 컨트랙트를 통해 전송된 트랜잭션을 확인하는 API
