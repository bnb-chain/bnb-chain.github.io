...
## Malicious Vote
To submit BSC slash evidence, please refer to [system contract](https://github.com/bnb-chain/bsc-genesis-contract) and call method `submitFinalityViolationEvidence`