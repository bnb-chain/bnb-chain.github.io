...
[MetaFi](https://www.bnbchain.world/en/blog/metafi-when-defi-meets-meta/) is a concept that provides advanced and sophisticated DeFi Infra to all the different types of projects such as metaverse, GameFi, SocialFi, Web3, and NFTs and puts them under one umbrella – MetaFi. To empower developers and users to build MetaFi applications adn custom blockchains, the BNB Chain community has rolled out the BNB Application Sidechain (BAS). BAS is a ready-to-use solution for developing custom blockchains and dApps with existing BSC functionality.  
...
3. **[BNB Application Sidechain](bas/overview/bas.md)** - ready-to-use solutions for developing custom blockchains and dApps with existing BSC functionality.
