...
To understand how does `quota` work, read [this](../../core-concept/billing-payment.md#storage-service-fee).
...
* [Storage Provider Introduction](../../storage-provider/overview.md): The Greenfield Storage Provider documents.
