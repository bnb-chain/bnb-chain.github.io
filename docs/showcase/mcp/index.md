...
| [**ask‑ai‑mcp**](./ask-ai-to-ide.md)                        | `https://api.superintern.ai/agent/async/mcp/mcp`                | Read-only semantic search over BNB Chain docs, BEPs, blogs & FAQs | Quick answers in chat panes or command palettes.                    |
...
* **Official Skills for AI** – [Skills for AI Agents](../mcp/skills.md): official instructions and agent commands (`npx @bnb-chain/mcp@latest`). Use this page so your agent can connect to BNB Chain.
