...
- 스테이킹 페이지로 갑니다:
    ...
    - 메인넷: <https://www.binance.org/en/staking>
...
한 위임자와 source 검증인, 도착 검증인 간의 재위임은 7일에 한번 가능합니다.
...
- 새로고침 후 아래와 같이 재위임 내역을 확인할 수 있습니다.
...
- 새로고침 후 아래와 같이 위임 변경 내역을 확인할 수 있습니다.
